...
1. **Network Expansion Event**: Criminal trafficking network successfully scales operations to new geography or labor sector. Criminal Network Capacity +8-15, Labor Demand Spike for trafficked workers (+20-30% in affected sector), recruitment accelerates. Triggered by: Border Control below 35 AND Labor Market Formalization below 40 AND Criminal Network Capacity above 50. Effect: 15,000-50,000 additional victims trafficked annually, $2-6B additional criminal revenue, increased violence against competitors.

2. **Border Crisis Trafficking Surge**: Major migration crisis (refugee flow, economic collapse in originating region) creates massive population displacement, trafficking networks exploit displacement. Criminal Network Capacity +10-20 (rapid recruitment from vulnerable migrants), Border Control overwhelmed (-15-25 effective capacity), Public Concern spikes (+30-40 but often misdirected toward immigration rather than trafficking exploitation). Estimated 200,000-500,000 additional trafficking victims during major crisis window.

3. **Major Trafficking Ring Bust**: Law enforcement/NGO operation successfully dismantles significant trafficking network through arrests, victim rescues, financial disruption. Criminal Network Capacity -8-12, Victim Support Infrastructure gains +15 (immediate surge of rescued victims requiring services). Creates short-term enforcement momentum but network regenerates within 2-5 years unless underlying demand/corruption addressed. Requires coordination between 3+ jurisdictions, international law enforcement cooperation, and Justice System Investment above 55.

4. **Supply Chain Scandal**: Media investigation exposes trafficking victims in high-profile supply chains (fashion, agriculture, tech manufacturing, chocolate). Public Concern +25-35, Corporate Accountability pressure (+regulatory mandates), Public & Institutional Awareness +10-18. Creates temporary market disruption but supply chains adapt: either higher audit costs (+5% product prices), offshoring to less-scrutinized suppliers, or actual labor reforms. Effect: $5-15B in market reorganization, 2-4 year enforcement window before normalization.

5. **Corruption Breakthrough**: Whistleblower or investigation reveals systematic trafficking facilitation by government officials (border guards, police, magistrates). Legitimacy crash for justice system (-25 public trust), Criminal Network visibility increases (-15-25 effective enforcement capacity as corruption networks exposed), international pressure for reforms (+60% likelihood of anti-trafficking funding increase). Short-term chaos; longer-term institutional reform possible.

6. **Victim Rescue Backlash**: Law enforcement raid on trafficking location results in disproportionate harm to victims (violence during rescue, deportation of trafficking survivors, inadequate support), media coverage creates victim-blaming narrative. Public & Institutional Awareness decreases (-10-15), victim reporting collapses (-40-60%), trust in anti-trafficking organizations drops (-20). Reveals enforcement-victim tension: aggressive tactics intended to "rescue" can retraumatize victims.
