...
1. **Localized Urban Spoofing Campaign**: Criminal or activist networks deploy low-power spoofing transmitters in major cities (New York, London, Tokyo), creating 50-500 meter position error zones affecting 10-100km radius. Impacts: Ride-sharing vehicle routing failures (Uber/Lyft coordinates drivers 500m away from customers), delivery drone losses (10-50 aircraft per day unable to land precisely), ATM location spoofing (customers directed to wrong locations, increasing robberies 20-40% in spoofed zones). Duration: 4-7 days before identification and equipment seizure. Estimated economic impact per incident: $50-200M.

2. **Regional Aviation Spoofing**: Nation-state or organized crime conducts spoofing campaign near major airport approach paths, degrading GNSS accuracy to 5-10 meters during precision approach windows. Consequence: 60-150+ diversions per week, cascading delays affecting 2,000-5,000+ passengers daily, fuel costs $10-30M, and increased accident risk (1-3 near-misses per 100 diversions). Coordinated with power grid spoofing creates dual crisis: grounded aircraft + destabilized grid. Duration: 2-8 weeks before detection by satellite monitoring networks. Impact: $500M-$2B economic damage; 5-20 fatalities from stress-induced medical emergencies and emergency diverts.

3. **Port Facilities Spoofing**: Sophisticated attack targets container port navigation by spoofing GNSS in confined harbor regions (few km²), causing ships to perceive false positions and trigger collision avoidance maneuvers. Consequence: Port throughput collapse (10-30% reduction in container handling), vessel collisions (2-8 per incident per major port), and cascading supply chain delays affecting downstream logistics. Duration: 3-14 days before port closes for manual navigation protocols. Secondary impacts: Insurance claims surge $100-500M; port closure disrupts 5-50M tons of cargo movements globally.

4. **Financial Market Clock Spoofing**: Precision attack on GNSS timing receivers at major financial institutions simultaneously during market hours; timestamp errors create 50-200ms discrepancies in trade settlement. Consequence: Flash crash dynamics (automated trading algorithms attempting to correct perceived synchronization failures), derivative settlement failures ($5-50B notional), and multi-day market closures as exchanges verify timing. Regulatory response: Emergency trading halts, increased circuit breaker sensitivity, trading volume compression 30-50% for weeks post-incident. Global financial impact: $100B-$1T in valuation losses and settlement disruptions.

5. **Coordinated Multi-Domain Spoofing (Military Theater)**: Nation-state deploys GNSS spoofing across 500+ km operational area during military crisis/conflict. Impacts: Precision weapons degraded 10-100x (cruise missiles miss targets 100-1000m, artillery requires 3-5x more rounds for same effect), drone swarms lose coordination and crash (20-40% loss rates), logistics convoys lose positioning and collide (15-30% attrition), command-and-control loses frequency synchronization. Consequence: Combat effectiveness collapse, civilian population caught in extended conflict duration, 100-1000x increase in civilian casualties relative to precision-guided scenario.

6. **Power Grid Cascade Spoofing**: Coordinated attack spoofs GNSS signals at grid synchronization points across multiple regions simultaneously, causing 5-15 substations to lose frequency reference within milliseconds. Consequence: Cascading blackouts affecting 10-50M people, restoration times 12-48 hours (vs. 2-6 hours for non-GNSS dependent grid), economic losses $500M-$5B. Attack becomes template for future grid destabilization; defensive investments multiply 2-5x across utilities.

7. **Persistent Regional Spoofing Degradation**: Adversary establishes semi-permanent spoofing presence in strategic location (chokepoint strait, critical border region, economic zone) creating chronic GNSS unreliability. Impacts: Insurance companies increase premiums 30-50% for vessels/aircraft in affected zones, causing 15-35% of traffic to reroute through longer paths, raising energy/time costs 5-20% globally for affected routes. Duration: Weeks to months. Secondary consequence: Economic degradation of spoofed regions as investment and logistics corridors shift elsewhere; regional GDP losses 2-5% annually.

8. **Authentication Infrastructure Collapse**: Multiple independent spoofing detection systems fail simultaneously due to coordinated cyber attacks, equipment failures, or malicious firmware updates. Consequence: Weeks of position uncertainty across aviation, maritime, and critical infrastructure sectors. Regulatory response: Emergency mandates for redundant independent positioning systems (inertial navigation, radio beacons, etc.), creating $50-200B global investment requirement.
