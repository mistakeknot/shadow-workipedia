...
**Event Types:**
1. **Unilateral SRM Deployment**: A major power, coalition (US-Japan, China-India), or wealthy consortium deploys SAI, marine cloud brightening, or similar SRM without international agreement. Triggers immediate diplomatic crisis, UN emergency sessions, and counter-deployment planning by rival blocs. Occurs most likely during severe heat waves, agricultural crises, or geopolitical instability.
2. **Termination Shock Coercion**: A dominant SRM-deploying coalition leverages termination shock risk to extort political concessions from other nations—trade access, military non-intervention, territorial claims, or resource rights. Threatens withdrawal of SRM support, triggering economic panic and potential global famine.
3. **Regional Precipitation Disruption**: SRM targeting one region's climate inadvertently shifts precipitation patterns 1000+ km away, triggering simultaneous droughts and floods in unexpected regions. Monsoons weaken in South Asia while Atlantic hurricane paths shift, stranding agricultural systems dependent on historical water availability.
4. **Attribution Failure & Blame-Shifting**: A major climate anomaly occurs (harvest failure, heat wave, drought) but scientists cannot definitively attribute it to natural variability, SRM effects, or cumulative warming. Competing nations blame each other; public loses trust in climate science; policy paralysis deepens.
5. **Counter-Deployment Escalation**: Two or more powers deploy overlapping, misaligned SRM programs in the same atmospheric region, creating unpredictable interference patterns, atmospheric instability, and potential runaway effects. Atmospheric circulation models fail; weather becomes genuinely chaotic.
6. **SRM Infrastructure Sabotage**: Military action, terrorism, or cyber warfare targets geoengineering delivery systems—aircraft fleets, stratospheric injection pumps, cloud-brightening vessels, or command-and-control networks. Sabotage triggers rapid warming in previously cooled regions; nations retaliate; hybrid warfare becomes normalized.
7. **Carbon Metabolism Shift**: Extended SRM deployment alters soil carbon cycles, ocean productivity, and ecosystem photosynthesis rates. Vegetation adapts to cooler, dimmer conditions; if SRM suddenly halts, these adapted ecosystems fail catastrophically under returned light and temperature conditions.
8. **Public Health Cascades**: Diffuse sunlight under heavy SRM reduces vitamin D synthesis globally, increases respiratory infections from altered air quality, disrupts agricultural systems dependent on specific light spectra, and creates novel disease patterns as ecological niches shift.
